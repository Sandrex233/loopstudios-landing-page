...
const Navbar = () => {
    ...
    return (
        <div className='flex h-28 items-center justify-between p-20'>
            <div>
                <img src={Logo} alt="" className='w-32 md:w-full' />
            </div>
            ...
            <ul className='hidden md:flex text-center gap-5 text-white font-jsans font-bold py-2'>
            ...
            <div className={!nav
                ...
                <img src={Logo} alt="" className='md:hidden flex w-32 absolute top-[70px] left-[80px]' />
